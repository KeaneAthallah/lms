...
export default function FooterSection() {
    ...
    return (
        <footer className="border-t border-slate-200 bg-white">
            <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)]">
                <div>
                    <Link to="/" className="flex items-center gap-2.5">
                        <span className="relative flex h-9 w-9 items-center justify-center rounded-lg border border-brand-200 bg-white text-brand-700 shadow-sm">
                        ...
                        <span className="text-base font-bold tracking-tight text-slate-900">{name}</span>
                    </Link>
                    <p className="mt-4 max-w-sm text-sm leading-relaxed text-slate-500">
                        Platform Pembelajaran Digital — sistem manajemen pembelajaran terstruktur yang menyelenggarakan
                        kursus, materi digital, evaluasi, pemantauan kemajuan, dan penerbitan sertifikat.
                    </p>
                    <Link
